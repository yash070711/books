...
function Footer() {
  return (
    <div className='footer1'>
        <img src='https://mysta.b-cdn.net/wp-content/uploads/2022/01/astrology-circle-orance-dots-1536x1536.png
        '/>
       ...
       <span >
        <p10 className='vty'>© PUMA India Ltd, 2023. All Rights Reserved
</p10>
       </span>
